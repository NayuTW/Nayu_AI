...
TOOL_CALLING_PROMPT = """You must respond with ONLY a valid JSON object, nothing else. Do not include any explanatory text before or after the JSON.
...
class OllamaLLM:
    ...
    async def chat(self, messages, tools=None):
        ...
        sys_aug = []
        if tool_str:
            sys_aug.append({"role": "system", "content": TOOL_CALLING_PROMPT.format(tools=tool_str)})
        payload = {
            "model": self.model,
